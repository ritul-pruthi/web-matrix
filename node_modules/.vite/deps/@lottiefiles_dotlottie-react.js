...
//#region node_modules/@lottiefiles/dotlottie-react/dist/browser/index.js
...
var d = typeof window < `u` && window.document !== void 0, f = new Uint8Array([
	80,
	75,
	3,
	4
	...
	`w`,
	`h`
], m = `0.67.0`, h = `@lottiefiles/dotlottie-web`;
var g;
function _(e) {
	let t = g.__externref_table_alloc_command_export();
	return g.__wbindgen_export_2.set(t, e), t;
}
function v(e, t) {
	try {
		...
		let t = _(e);
		g.__wbindgen_exn_store_command_export(t);
	}
}
var y = 0, b = null;
function x() {
...
} }, C = typeof S.encodeInto == `function` ? function(e, t) {
...
function w(e, t, n) {
	if (n === void 0) {
		let n = S.encode(e), r = t(n.length, 1) >>> 0;
		return x().subarray(r, r + n.length).set(n), y = n.length, r;
	}
	let r = e.length, i = t(r, 1) >>> 0, a = x(), o = 0;
	for (; o < r; o++) {
	...
	if (o !== r) {
		...
		let t = x().subarray(i + o, i + r), a = C(e, t);
...
var E = null;
function D() {
	return (E === null || E.buffer.detached === !0 || E.buffer.detached === void 0 && E.buffer !== g.memory.buffer) && (E = new DataView(g.memory.buffer)), E;
}
var O = typeof TextDecoder < `u` ? new TextDecoder(`utf-8`, {
	ignoreBOM: !0,
	fatal: !0
}) : { decode: () => {
...
function k(e, t) {
	return e >>>= 0, O.decode(x().subarray(e, e + t));
}
function A(e, t) {
	let n = t(e.length * 1, 1) >>> 0;
	return x().set(e, n / 1), y = e.length, n;
}
var j = null;
function M() {
...
function N(e, t) {
	...
	return M().set(e, n / 4), y = e.length, n;
}
function ee(e, t) {
	let n = t(e.length * 4, 4) >>> 0;
	for (let t = 0; t < e.length; t++) {
		let r = _(e[t]);
		D().setUint32(n + 4 * t, r, !0);
	}
	return y = e.length, n;
}
function te(e, t) {
	let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y, i = A(t, g.__wbindgen_malloc_command_export), a = y;
	return g.register_font(n, r, i, a) !== 0;
}
var P = Object.freeze({
	Forward: 0,
	0: `Forward`,
	...
	ReverseBounce: 3,
	3: `ReverseBounce`
}), F = typeof FinalizationRegistry > `u` ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((e) => g.__wbg_dotlottieplayerwasm_free(e >>> 0, 1));
var ne = class {
	__destroy_into_raw() {
	...
	free() {
		...
		g.__wbg_dotlottieplayerwasm_free(e, 0);
	}
	constructor() {
		return this.__wbg_ptr = g.dotlottieplayerwasm_new() >>> 0, F.register(this, this.__wbg_ptr, this), this;
	}
	load_animation(e, t, n) {
		let r = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i = y;
		return g.dotlottieplayerwasm_load_animation(this.__wbg_ptr, r, i, t, n) !== 0;
	}
	load_dotlottie_data(e, t, n) {
		let r = A(e, g.__wbindgen_malloc_command_export), i = y;
		return g.dotlottieplayerwasm_load_dotlottie_data(this.__wbg_ptr, r, i, t, n) !== 0;
	}
	load_animation_from_id(e, t, n) {
		let r = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i = y;
		return g.dotlottieplayerwasm_load_animation_from_id(this.__wbg_ptr, r, i, t, n) !== 0;
	}
	tick() {
	...
	resize(e, t) {
		return g.dotlottieplayerwasm_resize(this.__wbg_ptr, e, t) !== 0;
	}
	get_pixel_buffer() {
	...
	set_frame(e) {
		return g.dotlottieplayerwasm_set_frame(this.__wbg_ptr, e) !== 0;
	}
	seek(e) {
		return g.dotlottieplayerwasm_seek(this.__wbg_ptr, e) !== 0;
	}
	duration() {
	...
	set_mode(e) {
		g.dotlottieplayerwasm_set_mode(this.__wbg_ptr, e);
	}
	speed() {
		return g.dotlottieplayerwasm_speed(this.__wbg_ptr);
	}
	set_speed(e) {
		g.dotlottieplayerwasm_set_speed(this.__wbg_ptr, e);
	}
	loop_animation() {
		return g.dotlottieplayerwasm_loop_animation(this.__wbg_ptr) !== 0;
	}
	set_loop(e) {
		g.dotlottieplayerwasm_set_loop(this.__wbg_ptr, e);
	}
	loop_count() {
		return g.dotlottieplayerwasm_loop_count(this.__wbg_ptr) >>> 0;
	}
	set_loop_count(e) {
		g.dotlottieplayerwasm_set_loop_count(this.__wbg_ptr, e);
	}
	autoplay() {
		return g.dotlottieplayerwasm_autoplay(this.__wbg_ptr) !== 0;
	}
	set_autoplay(e) {
		g.dotlottieplayerwasm_set_autoplay(this.__wbg_ptr, e);
	}
	...
	set_use_frame_interpolation(e) {
		g.dotlottieplayerwasm_set_use_frame_interpolation(this.__wbg_ptr, e);
	}
	background_color() {
		return g.dotlottieplayerwasm_background_color(this.__wbg_ptr) >>> 0;
	}
	set_background_color(e) {
		return g.dotlottieplayerwasm_set_background_color(this.__wbg_ptr, e) !== 0;
	}
	clear_background_color() {
		return g.dotlottieplayerwasm_clear_background_color(this.__wbg_ptr) !== 0;
	}
	set_quality(e) {
		return g.dotlottieplayerwasm_set_quality(this.__wbg_ptr, e) !== 0;
	}
	has_segment() {
	...
	set_segment(e, t) {
		return g.dotlottieplayerwasm_set_segment(this.__wbg_ptr, e, t) !== 0;
	}
	clear_segment() {
	...
	set_layout(e, t, n) {
		let r = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i = y;
		return g.dotlottieplayerwasm_set_layout(this.__wbg_ptr, r, i, t, n) !== 0;
	}
	layout_fit() {
		let e, t;
		try {
			let n = g.dotlottieplayerwasm_layout_fit(this.__wbg_ptr);
			return e = n[0], t = n[1], k(n[0], n[1]);
		} finally {
			g.__wbindgen_free_command_export(e, t, 1);
		}
	}
	layout_align_x() {
	...
	set_viewport(e, t, n, r) {
		return g.dotlottieplayerwasm_set_viewport(this.__wbg_ptr, e, t, n, r) !== 0;
	}
	set_color_slot(e, t, n, r) {
		let i = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a = y;
		return g.dotlottieplayerwasm_set_color_slot(this.__wbg_ptr, i, a, t, n, r) !== 0;
	}
	set_scalar_slot(e, t) {
		let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y;
		return g.dotlottieplayerwasm_set_scalar_slot(this.__wbg_ptr, n, r, t) !== 0;
	}
	set_text_slot(e, t) {
		let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y, i = w(t, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a = y;
		return g.dotlottieplayerwasm_set_text_slot(this.__wbg_ptr, n, r, i, a) !== 0;
	}
	set_vector_slot(e, t, n) {
		let r = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i = y;
		return g.dotlottieplayerwasm_set_vector_slot(this.__wbg_ptr, r, i, t, n) !== 0;
	}
	set_position_slot(e, t, n) {
		let r = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i = y;
		return g.dotlottieplayerwasm_set_position_slot(this.__wbg_ptr, r, i, t, n) !== 0;
	}
	clear_slots() {
		return g.dotlottieplayerwasm_clear_slots(this.__wbg_ptr) !== 0;
	}
	clear_slot(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_clear_slot(this.__wbg_ptr, t, n) !== 0;
	}
	set_slots_str(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_set_slots_str(this.__wbg_ptr, t, n) !== 0;
	}
	set_slot_str(e, t) {
		let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y, i = w(t, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a = y;
		return g.dotlottieplayerwasm_set_slot_str(this.__wbg_ptr, n, r, i, a) !== 0;
	}
	get_slot_str(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y, r = g.dotlottieplayerwasm_get_slot_str(this.__wbg_ptr, t, n), i;
		return r[0] !== 0 && (i = k(r[0], r[1]).slice(), g.__wbindgen_free_command_export(r[0], r[1] * 1, 1)), i;
	}
	get_slots_str() {
		let e, t;
		try {
			let n = g.dotlottieplayerwasm_get_slots_str(this.__wbg_ptr);
			return e = n[0], t = n[1], k(n[0], n[1]);
		} finally {
			g.__wbindgen_free_command_export(e, t, 1);
		}
	...
	get_slot_type(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y, r = g.dotlottieplayerwasm_get_slot_type(this.__wbg_ptr, t, n), i;
		return r[0] !== 0 && (i = k(r[0], r[1]).slice(), g.__wbindgen_free_command_export(r[0], r[1] * 1, 1)), i;
	}
	reset_slot(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_reset_slot(this.__wbg_ptr, t, n) !== 0;
	}
	reset_slots() {
		return g.dotlottieplayerwasm_reset_slots(this.__wbg_ptr) !== 0;
	}
	intersect(e, t, n) {
		let r = w(n, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), i = y;
		return g.dotlottieplayerwasm_intersect(this.__wbg_ptr, e, t, r, i) !== 0;
	}
	get_layer_bounds(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_get_layer_bounds(this.__wbg_ptr, t, n);
	}
	get_transform() {
		return g.dotlottieplayerwasm_get_transform(this.__wbg_ptr);
	}
	set_transform(e) {
		let t = N(e, g.__wbindgen_malloc_command_export), n = y;
		return g.dotlottieplayerwasm_set_transform(this.__wbg_ptr, t, n) !== 0;
	}
	tween(e, t) {
		return g.dotlottieplayerwasm_tween(this.__wbg_ptr, e, T(t) ? 4294967297 : Math.fround(t)) !== 0;
	}
	tween_with_easing(e, t, n, r, i, a) {
		return g.dotlottieplayerwasm_tween_with_easing(this.__wbg_ptr, e, T(t) ? 4294967297 : Math.fround(t), n, r, i, a) !== 0;
	}
	tween_stop() {
		return g.dotlottieplayerwasm_tween_stop(this.__wbg_ptr) !== 0;
	}
	tween_update(e) {
		return g.dotlottieplayerwasm_tween_update(this.__wbg_ptr, T(e) ? 4294967297 : Math.fround(e)) !== 0;
	}
	tween_to_marker(e, t) {
		let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y;
		return g.dotlottieplayerwasm_tween_to_marker(this.__wbg_ptr, n, r, T(t) ? 4294967297 : Math.fround(t)) !== 0;
	}
	markers() {
	...
	current_marker() {
		let e = g.dotlottieplayerwasm_current_marker(this.__wbg_ptr), t;
		return e[0] !== 0 && (t = k(e[0], e[1]).slice(), g.__wbindgen_free_command_export(e[0], e[1] * 1, 1)), t;
	}
	set_marker(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		g.dotlottieplayerwasm_set_marker(this.__wbg_ptr, t, n);
	}
	clear_marker() {
	...
	load_font(e, t) {
		let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y, i = A(t, g.__wbindgen_malloc_command_export), a = y;
		return g.dotlottieplayerwasm_load_font(this.__wbg_ptr, n, r, i, a) !== 0;
	}
	static unload_font(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_unload_font(t, n) !== 0;
	}
	set_theme(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_set_theme(this.__wbg_ptr, t, n) !== 0;
	}
	reset_theme() {
	...
	set_theme_data(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_set_theme_data(this.__wbg_ptr, t, n) !== 0;
	}
	theme_id() {
		let e = g.dotlottieplayerwasm_theme_id(this.__wbg_ptr), t;
		return e[0] !== 0 && (t = k(e[0], e[1]).slice(), g.__wbindgen_free_command_export(e[0], e[1] * 1, 1)), t;
	}
	animation_id() {
		let e = g.dotlottieplayerwasm_animation_id(this.__wbg_ptr), t;
		return e[0] !== 0 && (t = k(e[0], e[1]).slice(), g.__wbindgen_free_command_export(e[0], e[1] * 1, 1)), t;
	}
	manifest_string() {
		let e, t;
		try {
			let n = g.dotlottieplayerwasm_manifest_string(this.__wbg_ptr);
			return e = n[0], t = n[1], k(n[0], n[1]);
		} finally {
			g.__wbindgen_free_command_export(e, t, 1);
		}
	...
	get_state_machine(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y, r = g.dotlottieplayerwasm_get_state_machine(this.__wbg_ptr, t, n), i;
		return r[0] !== 0 && (i = k(r[0], r[1]).slice(), g.__wbindgen_free_command_export(r[0], r[1] * 1, 1)), i;
	}
	state_machine_id() {
		let e = g.dotlottieplayerwasm_state_machine_id(this.__wbg_ptr), t;
		return e[0] !== 0 && (t = k(e[0], e[1]).slice(), g.__wbindgen_free_command_export(e[0], e[1] * 1, 1)), t;
	}
	state_machine_load(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_state_machine_load(this.__wbg_ptr, t, n) !== 0;
	}
	state_machine_load_from_id(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_state_machine_load_from_id(this.__wbg_ptr, t, n) !== 0;
	}
	...
	sm_fire(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		return g.dotlottieplayerwasm_sm_fire(this.__wbg_ptr, t, n) !== 0;
	}
	sm_set_numeric_input(e, t) {
		let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y;
		return g.dotlottieplayerwasm_sm_set_numeric_input(this.__wbg_ptr, n, r, t) !== 0;
	}
	sm_get_numeric_input(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y, r = g.dotlottieplayerwasm_sm_get_numeric_input(this.__wbg_ptr, t, n);
		return r === 4294967297 ? void 0 : r;
	}
	sm_set_string_input(e, t) {
		let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y, i = w(t, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a = y;
		return g.dotlottieplayerwasm_sm_set_string_input(this.__wbg_ptr, n, r, i, a) !== 0;
	}
	sm_get_string_input(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y, r = g.dotlottieplayerwasm_sm_get_string_input(this.__wbg_ptr, t, n), i;
		return r[0] !== 0 && (i = k(r[0], r[1]).slice(), g.__wbindgen_free_command_export(r[0], r[1] * 1, 1)), i;
	}
	sm_set_boolean_input(e, t) {
		let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y;
		return g.dotlottieplayerwasm_sm_set_boolean_input(this.__wbg_ptr, n, r, t) !== 0;
	}
	sm_get_boolean_input(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y, r = g.dotlottieplayerwasm_sm_get_boolean_input(this.__wbg_ptr, t, n);
		return r === 16777215 ? void 0 : r !== 0;
	}
	sm_reset_input(e) {
		let t = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), n = y;
		g.dotlottieplayerwasm_sm_reset_input(this.__wbg_ptr, t, n);
	}
	sm_poll_event() {
		return g.dotlottieplayerwasm_sm_poll_event(this.__wbg_ptr);
	}
	sm_start(e, t) {
		let n = ee(t, g.__wbindgen_malloc_command_export), r = y;
		return g.dotlottieplayerwasm_sm_start(this.__wbg_ptr, e, n, r) !== 0;
	}
	sm_stop() {
	...
	sm_status() {
		let e, t;
		try {
			let n = g.dotlottieplayerwasm_sm_status(this.__wbg_ptr);
			return e = n[0], t = n[1], k(n[0], n[1]);
		} finally {
			g.__wbindgen_free_command_export(e, t, 1);
		}
	...
	sm_current_state() {
		let e, t;
		try {
			let n = g.dotlottieplayerwasm_sm_current_state(this.__wbg_ptr);
			return e = n[0], t = n[1], k(n[0], n[1]);
		} finally {
			g.__wbindgen_free_command_export(e, t, 1);
		}
	...
	sm_override_current_state(e, t) {
		let n = w(e, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), r = y;
		return g.dotlottieplayerwasm_sm_override_current_state(this.__wbg_ptr, n, r, t) !== 0;
	}
	sm_framework_setup() {
	...
	sm_post_click(e, t) {
		g.dotlottieplayerwasm_sm_post_click(this.__wbg_ptr, e, t);
	}
	sm_post_pointer_down(e, t) {
		g.dotlottieplayerwasm_sm_post_pointer_down(this.__wbg_ptr, e, t);
	}
	sm_post_pointer_up(e, t) {
		g.dotlottieplayerwasm_sm_post_pointer_up(this.__wbg_ptr, e, t);
	}
	sm_post_pointer_move(e, t) {
		g.dotlottieplayerwasm_sm_post_pointer_move(this.__wbg_ptr, e, t);
	}
	sm_post_pointer_enter(e, t) {
		g.dotlottieplayerwasm_sm_post_pointer_enter(this.__wbg_ptr, e, t);
	}
	sm_post_pointer_exit(e, t) {
		g.dotlottieplayerwasm_sm_post_pointer_exit(this.__wbg_ptr, e, t);
	}
...
function ie() {
	...
	return e.wbg = {}, e.wbg.__wbg_buffer_609cc3eee51ed158 = function(e) {
		...
		let e = g.__wbindgen_export_2, t = e.grow(4);
		...
		var i = T(r) ? 0 : w(r, g.__wbindgen_malloc_command_export, g.__wbindgen_realloc_command_export), a = y;
		D().setInt32(e + 4, a, !0), D().setInt32(e + 0, i, !0);
...
function ae(e, t) {
	return g = e.exports, I.__wbindgen_wasm_module = t, E = null, j = null, b = null, g.__wbindgen_start(), g;
}
async function I(e) {
	...
	let { instance: n, module: r } = await re(await e, t);
	return ae(n, r);
}
var L = class {
	constructor() {
...
function B(e) {
	...
	let t = new Uint8Array(e.slice(0, f.byteLength));
	for (let e = 0; e < f.length; e += 1) if (f[e] !== t[e]) return !1;
	return !0;
}
function V(e) {
	return p.every((t) => Object.hasOwn(e, t));
}
function H(e) {
...
function U() {
	return 1 + ((d ? window.devicePixelRatio : 1) - 1) * .75;
}
function W(e) {
...
function ce(e, t, n) {
	...
	return {
		load() {
			return r || (r = e(i).then(() => void 0).catch(async (t) => {
				console.warn(`Primary WASM load failed from ${i}: ${t.message}`), console.warn(`Attempting to load WASM from backup URL: ${n}`);
				try {
					await e(n);
				} catch (e) {
					throw console.error(`Primary WASM URL failed: ${t.message}`), console.error(`Backup WASM URL failed: ${e.message}`), r = null, Error(`WASM loading failed from all sources.`);
				}
			})), r;
		},
		setWasmUrl(e) {
...
var q = ce(I, `https://cdn.jsdelivr.net/npm/${h}@${m}/dist/dotlottie-player.wasm`, `https://unpkg.com/${h}@${m}/dist/dotlottie-player.wasm`), J = (e) => {
	switch (e) {
		case `reverse`: return P.Reverse;
		case `bounce`: return P.Bounce;
		case `reverse-bounce`: return P.ReverseBounce;
		default: return P.Forward;
	}
}, le = (e) => {
	switch (e) {
		case P.Reverse: return `reverse`;
		case P.Bounce: return `bounce`;
		case P.ReverseBounce: return `reverse-bounce`;
...
var Y = class {
	...
	_drainSmEvents() {
		...
		for (; (t = this._dotLottieCore.sm_poll_internal_event()) != null;) {
			...
			if (e.type === `Message`) {
				let t = e.message ?? ``;
				d && t.startsWith(`OpenUrl: `) ? K(t) : this._eventManager.dispatch({
	...
	_loadFromData(e) {
		...
		if (typeof e == `string`) {
			...
			r = this._dotLottieCore.load_dotlottie_data(new Uint8Array(e), t, n);
		} else if (typeof e == `object`) {
			if (!H(e)) {
				this._dispatchError(`Invalid Lottie JSON object: The provided object does not conform to the Lottie JSON format.`);
				return;
			}
			r = this._dotLottieCore.load_animation(JSON.stringify(e), t, n);
		} else {
		...
		r ? (this._renderConfig.quality !== void 0 && this._dotLottieCore.set_quality(this._renderConfig.quality), d && this.resize(), this._drainPlayerEvents(), this._marker && this._dotLottieCore.set_marker(this._marker), setTimeout(() => {
			this._eventManager.dispatch({
				type: `frame`,
	...
	get layout() {
		if (this._dotLottieCore) return {
			...
			fit: ue(this._dotLottieCore.layout_fit())
		};
	}
	get marker() {
	...
	_draw() {
		if (!(this._dotLottieCore === null || this._canvas === null) && (!this._context && `getContext` in this._canvas && typeof this._canvas.getContext == `function` && (typeof HTMLCanvasElement < `u` && this._canvas instanceof HTMLCanvasElement || typeof OffscreenCanvas < `u` && this._canvas instanceof OffscreenCanvas) && (this._context = this._canvas.getContext(`2d`)), this._context)) {
			let e = this._dotLottieCore.get_pixel_buffer(), t = this._canvas.width * this._canvas.height * 4;
			if (e.byteLength !== t) {
			...
			this._bufferMismatchCount = 0, this._lastExpectedBufferSize = t;
			let n = null, r = new Uint8ClampedArray(e.buffer, e.byteOffset, e.byteLength);
			typeof ImageData > `u` ? (n = this._context.createImageData(this._canvas.width, this._canvas.height), n.data.set(r)) : n = new ImageData(r, this._canvas.width, this._canvas.height), this._context.putImageData(n, 0, 0);
		}
	}
	_cleanupCanvas() {
	...
	_animationLoop() {
		...
		try {
			let e = this._isStateMachineRunning ? this._dotLottieCore.sm_tick() : this._dotLottieCore.tick();
			this._isStateMachineRunning ? this._drainSmEvents() : this._drainPlayerEvents(), e && this._draw(), this._animationFrameId = this._frameManager.requestAnimationFrame(this._animationLoop.bind(this));
		} catch (e) {
	...
	play() {
		...
		this._drainPlayerEvents(), (e || this._dotLottieCore.is_playing()) && (this._isFrozen = !1, this._startAnimationLoop()), this._canvas && d && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !W(this._canvas) && this.freeze();
	}
	pause() {
	...
	setFrame(e) {
		if (this._dotLottieCore !== null && this._dotLottieCore.seek(e)) {
	...
	setBackgroundColor(e) {
		this._dotLottieCore !== null && (d && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = e : this._dotLottieCore.set_background_color(se(e)), this._backgroundColor = e);
	}
	setLoop(e) {
	...
	destroy() {
		this._stopAnimationLoop(), this._isStateMachineRunning = !1, this._cleanupCanvas(), this._dotLottieCore?.free(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: `destroy` }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
	}
	freeze() {
	...
	setSegment(e, t) {
		this._dotLottieCore !== null && this._dotLottieCore.set_segment(e, t);
	}
	setMode(e) {
	...
	setMarker(e) {
		this._dotLottieCore !== null && (this._marker = e, this._dotLottieCore.set_marker(e));
	}
	markers() {
	...
	tween(e, t) {
		return this._dotLottieCore ? this._dotLottieCore.tween_with_easing(e, t, 0, 0, 1, 1) : !1;
	}
	tweenToMarker(e, t) {
		return this._dotLottieCore ? this._dotLottieCore.tween_to_marker(e, t) : !1;
	}
	animationSize() {
	...
	getLayerBoundingBox(e) {
		let t = this._dotLottieCore?.get_layer_bounds(e);
		if (t && t.length === 8) return Array.from(t);
	}
	...
	getWorker(e) {
		return this._workers.has(e) || this._workers.set(e, new de()), this._workers.get(e);
	}
...
var Q = class e {
	constructor(t) {
		if (s(this, `_eventManager`, new L()), s(this, `_id`, void 0), s(this, `_worker`, void 0), s(this, `_canvas`, void 0), s(this, `_dotLottieInstanceState`, {
			...
			isReady: !1,
			manifest: null
		}), s(this, `_created`, !1), s(this, `_boundOnClick`, null), s(this, `_boundOnPointerUp`, null), s(this, `_boundOnPointerDown`, null), s(this, `_boundOnPointerMove`, null), s(this, `_boundOnPointerEnter`, null), s(this, `_boundOnPointerLeave`, null), s(this, `_pendingConfig`, null), t.canvas) {
		...
		this._pendingConfig = r, this._canvas && (this._create(r), this._pendingConfig = null), this._worker.addEventListener(`message`, this._handleWorkerEvent.bind(this));
	}
	...
	async destroy() {
		this._created && (this._created = !1, await this._sendMessage(`destroy`, { instanceId: this._id }), this._cleanupStateMachineListeners(), e._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), d && this._canvas instanceof HTMLCanvasElement && (R.unobserve(this._canvas), z.unobserve(this._canvas)));
	}
	async freeze() {
	...
	async tween(e, t) {
		return this._created ? this._sendMessage(`tween`, {
			instanceId: this._id,
			frame: e,
			duration: t
		}) : !1;
	}
	async tweenToMarker(e, t) {
		return this._created ? this._sendMessage(`tweenToMarker`, {
			instanceId: this._id,
			marker: e,
			duration: t
		}) : !1;
	...
	async _sendMessage(e, t, n) {
		...
		return this._worker.postMessage(r, n || []), new Promise((t, n) => {
			let i = (a) => {
				let o = a.data;
				o.id === r.id && (this._worker.removeEventListener(`message`, i), o.error ? n(Error(`Failed to execute method ${e}: ${o.error}`)) : t(o.result));
			};
...
var $ = ({ animationId: i, autoplay: a, backgroundColor: o, className: s, createDotLottie: c, data: l, dotLottieRefCallback: u, layout: d, loop: f, mode: p, playOnHover: m, renderConfig: h, segment: g, speed: _, src: v, stateMachineConfig: y, stateMachineId: b, style: x, themeData: S, themeId: C, useFrameInterpolation: w, workerId: T, ...E }) => {
	...
	return (0, import_react.useEffect)(() => {
		...
		typeof g?.[0] == `number` && typeof g[1] == `number` && D.current?.setSegment(g[0], g[1]);
...
}, pe = (e) => new Y(e), me = (e) => (0, import_jsx_runtime.jsx)($, {
	...e,
	createDotLottie: pe
}), he = (e) => new Q(e), ge = (e) => (0, import_jsx_runtime.jsx)($, {
	...e,
	createDotLottie: he
}), _e = (e) => {
	Q.setWasmUrl(e), Y.setWasmUrl(e);
};
//#endregion
export { me as DotLottieReact, ge as DotLottieWorkerReact, _e as setWasmUrl };
